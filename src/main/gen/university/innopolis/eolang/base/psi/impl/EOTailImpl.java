...
public class EOTailImpl extends ASTWrapperPsiElement implements EOTail {

  public EOTailImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public EOObject getObject() {
    return findNotNullChildByClass(EOObject.class);
  }
