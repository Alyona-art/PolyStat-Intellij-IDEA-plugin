...
public class EOAttributesImpl extends ASTWrapperPsiElement implements EOAttributes {

  public EOAttributesImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public List<EOAttribute> getAttributeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EOAttribute.class);
  }
